...
class AABBTreeEdge : public AABBTree
{
public:
	AABBTreeEdge(void);
	AABBTreeEdge(std::vector<Vec3f>* node, std::vector<Vec2i>* edge);
	virtual ~AABBTreeEdge(void);

//functions
public:
	void init(std::vector<Vec3f>* nodePos, std::vector<Vec2i>* edge);
