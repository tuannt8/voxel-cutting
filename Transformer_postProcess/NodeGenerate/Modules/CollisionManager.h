...
public:
	...
	bool isSurfaceWithAABBIntersectBox(AABBNode* node, Box b, std::vector<Vec3f> *points, std::vector<Vec3i> *face);
	...
	bool collisionBtwSurfAndLineSeg_part_T(SurfaceObj* obj, Vec3f l1, Vec3f l2, double radius, double margin);//return Collided Tri Idx
	...
	bool collisionBtwSurfAndLineSeg_part(SurfaceObj* obj, Vec3f l1, Vec3f l2, double radius, double margin, bool bHidden);
...
private:
	...
	void printBVHIdx(AABBNode* root);
