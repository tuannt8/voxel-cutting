...
public:
	...
	int ReadData(char* filename)
	{
		...
		char str[100];
		CStringA temp;
		CStringA normal="normal";
		CStringA vertex="vertex";
		CStringA endloop="endloop";
		CStringA endsolid="endsolid";
		...
		CStringA currentSavePoint="ii";
		CStringA ii="ii"; CStringA jj="jj"; CStringA kk="kk";
		while(1)
		{
			fscanf(fp, "%s\n", str);
			temp=str;
			...
			if(temp==vertex)
			{
				...
				fscanf(fp, "%s\n", str);
				temp=str;
				comparePoint.z=atof(temp.GetBuffer());
