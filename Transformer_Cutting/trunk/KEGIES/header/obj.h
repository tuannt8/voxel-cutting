...
public:
	...
	int ReadObjData(char* filename)
	{
		...
		//point normal vector calculation
	...
	int DrawObject(int mode, vec3d color, int normalD = 1) 
	{
		...
		if(mode==1 || mode==3)
		{
			...
			//	glNormal3f(m_FaceNormal[i].x,m_FaceNormal[i].y,m_FaceNormal[i].z);
				glNormal3f(normalD*m_PointNormal[m_Face[i].ii].x,normalD*m_PointNormal[m_Face[i].ii].y,normalD*m_PointNormal[m_Face[i].ii].z);
				glVertex3f(m_Point[m_Face[i].ii].x, m_Point[m_Face[i].ii].y, m_Point[m_Face[i].ii].z);
				glNormal3f(normalD*m_PointNormal[m_Face[i].jj].x,normalD*m_PointNormal[m_Face[i].jj].y,normalD*m_PointNormal[m_Face[i].jj].z);
				glVertex3f(m_Point[m_Face[i].jj].x, m_Point[m_Face[i].jj].y, m_Point[m_Face[i].jj].z);
				glNormal3f(normalD*m_PointNormal[m_Face[i].kk].x,normalD*m_PointNormal[m_Face[i].kk].y,normalD*m_PointNormal[m_Face[i].kk].z);
	...
	void setNewPoints(vec3d* newPoints)
	{
		if (m_Point)
		{
			delete []m_Point;
